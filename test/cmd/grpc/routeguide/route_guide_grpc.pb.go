...
type RouteGuideClient interface {
	...
	// Same as GetFeature, however it calls pingserver downstream
	GetFeatureWrapper(ctx context.Context, in *Point, opts ...grpc.CallOption) (*Feature, error)
...
func (c *routeGuideClient) GetFeatureWrapper(ctx context.Context, in *Point, opts ...grpc.CallOption) (*Feature, error) {
	out := new(Feature)
	err := c.cc.Invoke(ctx, "/routeguide.RouteGuide/GetFeatureWrapper", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RouteGuideServer interface {
	...
	// Same as GetFeature, however it calls pingserver downstream
	GetFeatureWrapper(context.Context, *Point) (*Feature, error)
	// A server-to-client streaming RPC.
	//
	// Obtains the Features available within the given Rectangle.  Results are
	// streamed rather than returned at once (e.g. in a response message with a
...
func (UnimplementedRouteGuideServer) GetFeatureWrapper(context.Context, *Point) (*Feature, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFeatureWrapper not implemented")
}
...
func _RouteGuide_GetFeatureWrapper_Handler(srv any, ctx context.Context, dec func(any) error, interceptor grpc.UnaryServerInterceptor) (any, error) {
	in := new(Point)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RouteGuideServer).GetFeatureWrapper(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/routeguide.RouteGuide/GetFeatureWrapper",
	}
	handler := func(ctx context.Context, req any) (any, error) {
		return srv.(RouteGuideServer).GetFeatureWrapper(ctx, req.(*Point))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RouteGuide_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetFeatureWrapper",
			Handler:    _RouteGuide_GetFeatureWrapper_Handler,
		},
	},
