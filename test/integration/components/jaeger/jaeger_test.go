...
func Fixture() *TracesQuery {
	...
	err := json.Unmarshal([]byte(`{"data":[{"traceID":"eae56fbbec9505c102e8aabfc6b5c481","spans":[{"traceID":"eae56fbbec9505c102e8aabfc`+
		...
		`:[{"key":"otel.library.name","type":"string","value":"github.com/open-telemetry/opentelemetry-ebpf-instrumentation"},{"key":"span.kind"`+
		...
		`","value":"github.com/open-telemetry/opentelemetry-ebpf-instrumentation"},{"key":"span.kind","type":"string","value":"internal"},{"key"`+
		...
		`artTime":1686641491452470,"duration":3322,"tags":[{"key":"otel.library.name","type":"string","value":"github.com/open-telemetry/opentelemetry-ebpf-instrumentation"`+
		...
		`","value":"github.com/open-telemetry/opentelemetry-ebpf-instrumentation"},{"key":"http.method","type":"string","value":"GET"},{"key":"h`+
		...
		`otel.library.name","type":"string","value":"github.com/open-telemetry/opentelemetry-ebpf-instrumentation"},{"key":"span.kind","type":"s`+
